...
class MapPathBuilder:
    ...
    @staticmethod
    def build_product_path(file_number: str) -> str | None:
        """
    ...
    @staticmethod
    def build_site_path(company_code: str, file_number: str) -> str | None:
        """
    ...
    def build_foreign_site_path(self, company_code, file_number) -> str| None:
        """
    ...
    @staticmethod
    def build_trading_partner_path(company_code) -> str | None:
        """
    ...
    @staticmethod
    def build_clinical_trial_path() -> str | None:
        """
    ...
    @staticmethod
    def build_company_path(company_code) -> str | None:
        """
    ...
    @staticmethod
    def build_master_file_path(company_code) -> str | None:
        """
